...
export const metadata: Metadata = {
  title: "CanDigit — Jasa Pembuatan Website Profesional",
  description:
    "CanDigit adalah jasa pembuatan website profesional yang membantu bisnis Anda tampil kredibel dan menarik di era digital. Landing page, company profile, toko online, dan custom web.",
